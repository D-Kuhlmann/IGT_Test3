...
function ButtonIgt({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div 
      className="bg-[#1474a4] relative rounded-[2px] shrink-0 w-full cursor-pointer hover:bg-[#1685b5] transition-colors" 
...
function StepsNestedComponentsSeriesMouseSmartNav({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start overflow-clip relative shrink-0 w-[292px]" data-name="Steps / Nested components / Series - Mouse (SmartNav)">
      <ButtonIgt onOpenWizard={onOpenWizard} />
      <ButtonIgt1 />
      <ButtonIgt2 />
    </div>
  );
...
function Slot({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Slot">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[20px] items-start pb-[20px] pt-0 px-[16px] relative w-full">
          <StepsNestedComponentsSeriesMouseSmartNav onOpenWizard={onOpenWizard} />
...
function Expander({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Expander">
      <Header1 />
      <Content2 onOpenWizard={onOpenWizard} />
...
function StepOverview({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div className="basis-0 bg-[#212121] content-stretch flex flex-col grow items-start min-h-px min-w-px overflow-clip relative shrink-0 w-full" data-name="Step overview">
      <Step1 onOpenWizard={onOpenWizard} />
      <Step2 />
      <Step3 />
    </div>
  );
...
function TaskGuidance({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div className="basis-0 bg-neutral-900 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0 w-[324px]" data-name="Task Guidance">
      <Header />
      <TaskOverview />
      <StepOverview onOpenWizard={onOpenWizard} />
    </div>
  );
}

function TaskGuidance1({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[324px]" data-name="Task Guidance">
      <TaskGuidance onOpenWizard={onOpenWizard} />
    </div>
  );
}
...
function Arrow() {
  return (
    <div className="absolute right-[4px] size-[24px] top-[110%] translate-y-[-50%]" data-name="Arrow">
      <ArrowDown />
    </div>
  );
}
...
function ContentArea({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div className="absolute bottom-0 content-stretch flex items-center left-0 right-0 top-[40px]" data-name="Content area">
      <TaskGuidance1 onOpenWizard={onOpenWizard} />
      <ViewAreaToolbar />
    </div>
  );
}
...
function Left2() {
  return (
    <div className="absolute box-border content-stretch flex gap-[48px] h-[48px] items-center left-[8px] pl-[8px] pr-0 py-0 top-[110%] translate-y-[-50%]" data-name="Left">
      <Left1 />
      <PatientInfo />
    </div>
  );
...
function Right1() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[48px] items-center justify-end right-[16px] top-[110%] translate-y-[-50%]" data-name="Right">
      <RightSide />
    </div>
  );
}
...
function TopRow() {
  return (
    <div className="content-stretch flex gap-[10px] h-[40px] items-center relative shrink-0 w-full" data-name="Top row">
      <Background />
      <Left2 />
      <Right1 />
    </div>
...
function NavigationBar() {
  return (
    <div className="absolute content-stretch flex flex-col h-[40px] items-start left-0 right-0 top-0" data-name="Navigation bar">
      <Template />
    </div>
  );
}

function FrameworkMouseSmartNav({ onOpenWizard }: { onOpenWizard?: () => void }) {
  return (
    <div className="absolute bg-black inset-0 overflow-clip" data-name="Framework / Mouse (SmartNav)">
      <ContentArea onOpenWizard={onOpenWizard} />
      <NavigationBar />
    </div>
  );
}

interface UniguideUIProps {
  onOpenWizard?: () => void;
  showVideo?: boolean;
  videoSrc?: string;
}

export function UniguideUI({ onOpenWizard, showVideo, videoSrc }: UniguideUIProps) {
  return (
    <div className="absolute inset-0" data-name="13.WS-ResultCBCTimage">
