      ...
      case 'Access':
        return (
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 39 37">
            <path d="M39.1667 24.24C34.605 29.7517 27.7133 33.2633 20 33.2633C12.2867 33.2633 5.395 29.7517 0.833333 24.24L14.8608 7.185C16.4117 7.95333 18.1525 8.39667 20 8.39667C21.8475 8.39667 23.5883 7.95333 25.1392 7.185L39.1667 24.24Z" fill="white"/>
          </svg>
        );
      case 'CCTA Planning':
      case 'Planning':
        return (
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
            <path d="M20 7.91667C13.3333 7.91667 7.91667 13.3333 7.91667 20C7.91667 22.8583 8.91667 25.4833 10.5833 27.55L15.9167 22.8833C15.3417 22.0667 15 21.075 15 20C15 17.2417 17.2417 15 20 15C22.7583 15 25 17.2417 25 20C25 21.075 24.6583 22.0667 24.0833 22.8833L29.4167 27.55C31.0833 25.4833 32.0833 22.8583 32.0833 20C32.0833 13.3333 26.6667 7.91667 20 7.91667ZM20 25C18.9167 25 17.9167 24.65 17.1 24.0667L11.7167 28.775C13.8833 30.825 16.7917 32.0833 20 32.0833C23.2083 32.0833 26.1167 30.8167 28.2833 28.775L22.9 24.0667C22.0833 24.65 21.0833 25 20 25ZM20 1.66667C9.875 1.66667 1.66667 9.875 1.66667 20C1.66667 24.8667 3.56667 29.2917 6.66667 32.575V38.3333H33.3333V32.575C36.4333 29.2917 38.3333 24.8667 38.3333 20C38.3333 9.875 30.125 1.66667 20 1.66667ZM20 34.5833C11.9583 34.5833 5.41667 28.0417 5.41667 20C5.41667 11.9583 11.9583 5.41667 20 5.41667C28.0417 5.41667 34.5833 11.9583 34.5833 20C34.5833 28.0417 28.0417 34.5833 20 34.5833Z" fill="white"/>
          </svg>
        );
      case 'IVUS':
        return (
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
            <path d="M20 15C22.75 15 25 17.25 25 20C25 22.75 22.75 25 20 25C17.25 25 15 22.75 15 20C15 17.25 17.25 15 20 15ZM20 10C14.475 10 10 14.475 10 20C10 25.525 14.475 30 20 30C25.525 30 30 25.525 30 20C30 14.475 25.525 10 20 10Z" fill="white" opacity="0.3"/>
            <path d="M20 10C25.525 10 30 14.475 30 20C30 25.525 25.525 30 20 30C14.475 30 10 25.525 10 20C10 14.475 14.475 10 20 10ZM20 5C11.725 5 5 11.725 5 20C5 28.275 11.725 35 20 35C28.275 35 35 28.275 35 20C35 11.725 28.275 5 20 5Z" fill="white" opacity="0.5"/>
            <path d="M20 5C28.275 5 35 11.725 35 20C35 28.275 28.275 35 20 35C11.725 35 5 28.275 5 20C5 11.725 11.725 5 20 5ZM20 1.66667C9.87083 1.66667 1.66667 9.87083 1.66667 20C1.66667 30.1292 9.87083 38.3333 20 38.3333C30.1292 38.3333 38.3333 30.1292 38.3333 20C38.3333 9.87083 30.1292 1.66667 20 1.66667Z" fill="white"/>
          </svg>
        );
      case 'Finalise':
        return (
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
            <path d="M19.1667 19.1667V37.5H37.5V35.8333H20.8333V20.8333H37.5V19.1667H19.1667ZM37.5 28.3333L28.3333 23.75V26.6667H22.5V30H28.3333V32.9167L37.5 28.3333Z" fill="white"/>
            <path d="M8.33333 10C8.33333 5.33333 12 1.66667 16.6667 1.66667C21.3333 1.66667 25 5.33333 25 10C25 14.6667 21.3333 18.3333 16.6667 18.3333C12 18.3333 8.33333 14.6667 8.33333 10ZM16.6667 19.9167C14.6667 19.9167 12.6667 19.25 11.1667 18.25H11.0833H10C6.33333 18.25 3.33333 21.25 3.33333 24.9167V31.5833H17.5V19.8333C17.25 19.9167 16.9167 19.9167 16.6667 19.9167Z" fill="white" opacity="0.5"/>
          </svg>
        );
      case '3D Scan':
        return (
...
export function SmartWorkflowBar({
  ...
  const workflowSteps: WorkflowStep[] = activePreset === 1 
    ? [
        // Preset 1: Cardiology workflow steps (matching SmartWorkflowsOverlay)
