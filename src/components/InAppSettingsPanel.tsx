...
export function InAppSettingsPanel() {
  ...
  return (
    <div className="bg-neutral-900 relative rounded-[8px] size-full overflow-auto" data-name="inApp-SettingsPanel">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-3 items-start justify-start px-2 py-3 relative size-full overflow-auto">
          <Lock 
