import svgPaths from "./svg-ynug6nhzaa";
...
export default function Frame302() {
  return (
    <div
      className="relative rounded-[10px] size-full"
      style={{
        backgroundImage:
    ...
    >
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex items-center justify-start p-[20px] relative size-full">
          <StartManual />
        </div>
      </div>
    </div>
