import { imgPath, imgVector, imgVector1, imgVector2, imgVector3, imgVector4, imgVector5, imgVector6, imgVector7, imgVector8, imgVector9, imgA, imgPath1, imgA1, img1Icons24VesselNavigatorPlanning, imgIconColor } from "./svg-x6sku";
...
function IconAutomationVoice() {
  return (
    <div className="h-9 opacity-60 relative shrink-0 w-10" data-name="icon_automation_voice">
      <AutoVoiceOff />
    </div>
  );
}
...
function IconAutomationSmartmask() {
  return (
    <div className="h-9 relative shrink-0 w-10" data-name="icon_automation_smartmask">
...
function IconAutomationCollimation() {
  return (
    <div className="h-9 opacity-60 relative shrink-0 w-10" data-name="icon_automation_collimation">
      <CropSquare />
...
export default function TsmSlidepanelAutomationGrouping() {
  return (
    <div className="backdrop-blur-sm backdrop-filter bg-[rgba(0,0,0,0.4)] relative rounded-bl-[4px] rounded-tl-[4px] size-full" data-name="tsm-Slidepanel-Automation-Grouping">
