...
import { imgExposureLabel, imgDlsTiltAngle48, imgSmartMask1, imgCropSquare, img1Icons24VesselNavigatorPlanning, imgDlsStopwatch48 } from "./svg-6n20x";
...
export default function StatusBar() {
  return (
    <div className="bg-[#050505] relative size-full" data-name="Status bar">
      <div className="flex flex-col items-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-10 items-center justify-start px-1.5 py-[22px] relative size-full">
          <SystemState />
          <Section2 />
          <Section3 />
          <Section4 />
