...
export default function XrayLiveContent() {
  return (
    <div className="content-start flex flex-wrap gap-[25px] items-start justify-start relative size-full" data-name="XrayLiveContent">
      <div className="basis-0 font-['CentraleSans:Book',_sans-serif] grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#d6d6d6] text-[0px]">
